...
DATASET_TRAIN = './Data/PimaIndian/train.csv'
DATASET_TEST = './Data/PimaIndian/test.csv'
...
grammar = {
    ...
    'var':  [('terminal',), ('const',)],
    'terminal': ['Pregnancies', 'Age', 'BMI', 'Glucose', 'BloodPressure', 'SkinThickness', 'Insulin','DiabetesPedigreeFunction'],
...
class gp:
    ...
    def write_to_file(self):
        with open('Transfer/pima.txt', 'w') as f:
            for indiv in self.population:
